...
import 'package:projetflutter/Masse_Corporelle/masse_corporelle_resultat.dart';
class Masse_Corporelle extends StatefulWidget {
  @override
  _Masse_Corporelle createState() => _Masse_Corporelle();
}

class _Masse_Corporelle extends State<Masse_Corporelle>
{
  bool isMale = true;
  double height = 180.0;
  int weight = 40;
          ...
          Container (
            ...
            child: MaterialButton(
              onPressed: (){
                 ...
                 firestore.collection("masse_corporelle").add({
                   "age":age,
                   "genre":isMale,
                   "resultat": result,
                 });
                ...
                Navigator.push(
                  context,
                  MaterialPageRoute(
                    builder: (context) => Masse_Corporelle_resultat(
                      result: result,
                      age: age,
